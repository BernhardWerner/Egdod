...
(function(){
	...
	drawOutline(image, size, color) := (
		...
		colorplot(
			vis = 0;
			repeat(a, vis = vis + imagergba(image, [x,y] + size *         [sin(2 * pi * # / a),     cos(2 * pi * # / a)])_4);
			repeat(b, vis = vis + imagergba(image, [x,y] + size * 2 / 3 * [sin(2 * pi * # / b + 2), cos(2 * pi * # / b + 2)])_4);
			repeat(c, vis = vis + imagergba(image, [x,y] + size     / 3 * [sin(2 * pi * # / c + 4), cos(2 * pi * # / c + 4)])_4);

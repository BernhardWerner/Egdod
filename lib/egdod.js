...
(function(){
	...
	rotate(point, alpha) := rotate(point, alpha, [0,0]);
		...
		*************************************************************************************************/
		selectorEnds(slider) := [slider.position, slider.position + if(slider.vertical, [0, -selector.gapSize * (length(selector.content) - 1)], [selector.gapSize * (length(selector.content) - 1), 0])];

	...
	rotate(point, alpha) := rotate(point, alpha, [0,0]);
		...
		*************************************************************************************************/
		...
		catchSelector(selector) := (
			...
			/*
		  	forall(1..length(selector.content),
			    if(dist(mouse().xy, lerp(endPoints_1, endPoints_2, #, 1, length(selector.content))) < selector.bulbSize + 0.02 * selector.size,
						selector.index = #;
					);
			  );
			*/
		...
		*************************************************************************************************/
		...
		catchColorSwatch(swatch) := catchSelector(swatch);
